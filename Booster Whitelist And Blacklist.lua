...
local whitelistTable = {
    booster = {
        ...
        { clientID = "c095c705-21e6-4b69-9343-46561a87392b"},
        { clientID = "597473de-4bb8-4882-9485-d29f6b0f5584"},
        { clientID = "4ff605e5-6229-4540-935e-31624a152961"},
        { clientID = "61AA7DDC-A3AB-4699-B8BD-C86A2ABA6EA0"},
        { clientID = "e92f689f-31e9-45d2-b9b3-4494a343e1e0"},
        { clientID = "E23F54C7-7A05-4CEF-8EA9-91E7617EE8B7"},
        { clientID = "1"},
        { clientID = "1"},
        { clientID = "1"}
    }
